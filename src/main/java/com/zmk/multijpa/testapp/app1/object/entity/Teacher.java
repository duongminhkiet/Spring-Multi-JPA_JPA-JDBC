...
@Entity
@Table(name=GlobalVariable.TBL_TEACHER_APP1)
public class Teacher implements Serializable {
	...
	@Column(name = "HoVaTen", nullable = false,columnDefinition = "nvarchar(255) default ''")
	private String name;
	
	@Column(name = "SoDienThoai_Chinh", nullable = true)
